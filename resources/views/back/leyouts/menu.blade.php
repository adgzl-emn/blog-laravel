...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('homepage')}}">
            ...
            <div class="sidebar-brand-text mx-3">Sarikaktus.com</div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('yazilar.index')}}">Tüm Yazılar</a>
                    <a class="collapse-item" href="{{route('yazilar.create')}}">Yazı Ekle</a>
                    <a class="collapse-item" href="{{route('silinen')}}">Silinen Yazılar</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{route('iletişim')}}">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="{{url('/')}}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            class="fas fa-download fa-sm text-white-50"></i> Siteyi Gör</a>
                </div>
