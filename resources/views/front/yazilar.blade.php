        ...
        <section class="awe-section">
            <div class="container">
                ...
                <div class="page-title pb-40">
                    <h2 class="page-title__title">Yazılar</h2>
                    <p class="page-title__text">İçerik Sayısı: {{$articles_say}}</p>
                                ...
                                <div class="grid-item__content-wrapper">
                                    ...
                                    <div class="post">
                                        ...
                                        <div class="post__body">
                                            ...
                                            <div class="post__meta"><span class="date">Tıklanma sayısı: </span><span class="author"><a href="#">{{$article->hit }}</a></span></div>
